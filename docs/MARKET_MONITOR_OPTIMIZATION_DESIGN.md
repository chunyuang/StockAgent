...
> 版本: v2.9.31 | 日期: 2026-05-31 | 基线分支: audit/V75-backtest-review
...
> 回测影响: 零文件修改, 940测试全通过(scanner 747+backtest 193)
...
| 模块 | 文件 | 行数 | 职责 |
|---|---|---|---|
| MarketScanner | scanner.py | 1538 | 信号扫描+持仓+风控+执行(委托模式+DelegateRouter) |
