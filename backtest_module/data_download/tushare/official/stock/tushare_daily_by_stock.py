...
async def download_by_stock_list(
    ...
    """按股票列表下载日线数据"""
    print(f"=== Tushare 官方 - 按股票下载日线 (独立回测模块) ===")
...
if __name__ == "__main__":
    # 使用方式:
    # python backtest_module/data_download/tushare/official/tushare_daily_by_stock.py start_date end_date [stock_list_file] [interval]
    # 间隔默认 1.0s
