...
v2.9.67更新: mixin拆分后方法分散在scanner_initializer.py和scan_loop_runner.py
"""
import ast
import os
import inspect
...
class TestInitBrokerDecomposition:
    """_init_broker拆分为_init_broker_gm/_init_broker_sim (v2.9.67: scanner_initializer.py混入)"""
