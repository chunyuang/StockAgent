...
GLOBAL_RISK = {
    ...
    "intraday_lock_min_high_rise": 0.06,  # 盘中利润锁定:冲高≥6%(V67:从5%→6%,5%对超短线来说偏低,3-5%的日内冲高很常见,过早锁定导致大量盈利股被退出;6%只在真正大冲高时触发,配合2.5%回撤阈值更精确;V72验证5%→325.41%回退-1.37%,5%过敏感)
...
STRATEGY_CONFIGS = {
    "halfway_chase": {
        ...
        "riskParams": {
            ...
            "hold_protection_threshold": 0.04,     # 【V71-P0-1:半路追涨持仓保护4%】V72验证5%过严导致利润锁定/冲高回落过多代替止盈,4%保护2-5%盈利股免于调仓卖出同时止盈12%能正常触发;5%→4%收益326.78%→320.46%回退-6%,4%仍是最优
