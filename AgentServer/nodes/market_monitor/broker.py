        ...
        try:
            ...
            if order is not None:
                order_doc = {
                    ...
                    "filled_amount": order.filled_price * order.filled_qty if order.filled_price and order.filled_qty else 0,
    ...
    async def _save_positions_to_mongo(self) -> None:
        ...
        for ts_code, pos in self.positions.items():
            ...
            positions_docs.append({
                ...
                "market_value": pos.current_price * pos.total_qty if pos.current_price > 0 else pos.avg_cost * pos.total_qty,
        ...
        today_orders = [
            {
                ...
                "filled_amount": o.filled_price * o.filled_qty if o.filled_price and o.filled_qty else 0,
