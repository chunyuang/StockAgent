"""V73-P0v2 回测验证 - P0-1/P0-2/P0-3 (不含P0-4情绪过滤)"""
...
async def main():
    ...
    task_id = f"v73_p0v2_{int(time.time())}"
    logs = []
    ...
    print(f"🚀 V73-P0v2 (不含P0-4) | {inner_params['start_date']}~{inner_params['end_date']}")
    t0 = time.time()
    ...
    out_path = os.path.join(BASE, 'V73_P0v2_result.json')
