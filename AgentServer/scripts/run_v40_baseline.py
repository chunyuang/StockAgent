"""V40基线回测 - 3策略默认参数(含策略级风控), 20250102~20250331"""
...
async def main():
    ...
    task_id = f"v40_baseline_{int(time.time())}"
    logs = []
    ...
    if result:
        ...
        # Save result
        with open(os.path.join(BASE, 'v40_baseline_result.json'), 'w') as f:
