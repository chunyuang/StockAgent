"""
修复 sync_records 表的同步日期

用于手动调整同步记录的日期，触发重新同步

Usage:
    # 修改单个类型的同步日期
    python scripts/fix_sync_date.py --types stock_daily_ak_full --date 20260101
    
    # 修改多个类型的同步日期
    python scripts/fix_sync_date.py --types stock_daily_ak_full,limit_list,daily_stats --date 20260201
    
    # 修改所有类型的同步日期
    python scripts/fix_sync_date.py --all --execute --date 20260101
    
    # 查看当前所有同步记录
    python scripts/fix_sync_date.py --list
"""
