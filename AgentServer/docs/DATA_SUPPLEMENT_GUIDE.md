...
> ⚠️ **本文档部分过时**（最后更新2026-05-06），数据现状和脚本已大幅更新。
>
> - 集合数从5个→19个，文档数从699K→2.79M
> - 东方财富已成为主力数据源，搜狐为fallback
> - 量脉API已降级为实时专用(DNS不稳定)
> - Tushare已恢复(5000积分)
> - 完整采补链路：**[DATA_COLLECTION_STRATEGY.md](./DATA_COLLECTION_STRATEGY.md)**
