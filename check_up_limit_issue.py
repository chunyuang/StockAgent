...
docs = list(db.stock_daily_ak.find(
    {'ts_code': 'sh600110.SZ'},
...
# 3. 检查其他股票
print('\n🔍 检查其他股票:')
other_docs = list(db.stock_daily_ak.find(
    {'trade_date': 20260105},
    {'ts_code': 1, 'close': 1, 'up_limit': 1}
).limit(5))

print(f'   20260105 的股票样本:')
...
# 4. 统计问题比例
print('\n📈 问题统计:')
count_total = db.stock_daily_ak.count_documents({'trade_date': 20260105})
count_wrong = db.stock_daily_ak.count_documents({
    'trade_date': 20260105,
...
# 抽样检查涨停价是否正确
sample_docs = list(db.stock_daily_ak.find(
    {'trade_date': 20260105},
    {'ts_code': 1, 'close': 1, 'up_limit': 1}
).limit(20))
