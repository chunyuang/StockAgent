...
const menuItems = [
  ...
  { path: '/stock-pool', icon: Opportunity, title: '今日预选池' },
  { path: '/rebalance', icon: ShoppingCart, title: '调仓操作' },
  { path: '/position', icon: Wallet, title: '今日持仓' },
  { path: '/performance-curve', icon: DataLineIcon, title: '业绩曲线' },
  { path: '/risk-control', icon: Setting, title: '风控中心' },
