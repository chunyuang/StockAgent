...
interface ScannerStatus { is_running: boolean; scan_count: number; last_scan_time: string; active_signals: number; positions: number; stocks_scanned: number; stats: ScanStats; account_id: string; trade_mode: string; dry_run?: boolean; circuit_breaker_paused?: boolean; circuit_breaker?: { trading_paused: boolean; pause_reason: string; buy_paused?: boolean; cumulative_drawdown?: number; position_cap?: number; peak_assets?: number; consecutive_losses?: number; today_trades?: number; today_losses?: number }; account: { total_assets: number; available_cash: number; market_value: number; total_profit: number }; data_sources?: Array<{ name: string; available: boolean; stocks: number; calls: number; limit: string; note: string }>; filter_pipeline?: { sentiment?: { score: number; period: string }; position_ratio?: number }; position_ratio?: number; position_count?: number }
