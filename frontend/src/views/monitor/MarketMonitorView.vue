...
async function fetchHealth() { try { const r = await api.get(`${scannerApi}/health`); if (r?.success) healthData.value = r.health || r.data?.health || r.data } catch { } }
