...
/* 【v2.9.99-r1 恢复 v17】信号小时分组 */
.sig-hour-header { display: flex; align-items: center; gap: 8px; padding: 5px 10px; margin: 6px 0 3px; background: var(--bg-muted); border-radius: 6px; cursor: pointer; font-size: 12px; font-weight: 600; color: var(--text-secondary); transition: background 0.15s; user-select: none; }
...
.pos-buy-date { font-size: 11px; color: var(--el-color-info); background: var(--info-bg, rgba(64,158,255,0.1)); padding: 1px 6px; border-radius: 3px; font-weight: 600; }
...
.ct-buy-date { font-size: 10px; color: var(--el-color-info); background: var(--info-bg, rgba(64,158,255,0.1)); padding: 0 4px; border-radius: 2px; }
