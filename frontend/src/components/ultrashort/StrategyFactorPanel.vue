...
const strategies: StrategyFactor[] = [
  ...
  },
  {
    ...
    entryFactors: [
      { name: 'limit_up_count', label: '5日涨停次数', condition: '≥1 (确认龙头地位)', source: 'factor_auto_compute' },
      { name: 'pullback_pct', label: '回调幅度', condition: '-35% ~ -5% (负数=回调)', source: 'factor_auto_compute' },
      { name: 'pullback_days', label: '回调天数', condition: '1~7天', source: 'factor_auto_compute' },
