...
export const useThemeStore = defineStore('theme', () => {
  ...
  function updateElementPlusTheme(): void {
    ...
    if (isDark.value) {
      ...
      root.style.setProperty('--el-bg-color-page', '#141c2e')
      root.style.setProperty('--el-bg-color-overlay', '#1e2a3a')
      root.style.setProperty('--el-text-color-primary', '#e2e8f0')
      root.style.setProperty('--el-text-color-regular', '#a0aec0')
      root.style.setProperty('--el-text-color-secondary', '#718096')
      root.style.setProperty('--el-text-color-placeholder', '#5a6577')
      root.style.setProperty('--el-border-color', '#2d4058')
      root.style.setProperty('--el-border-color-light', '#243447')
      root.style.setProperty('--el-border-color-lighter', '#1e2a3a')
      root.style.setProperty('--el-fill-color', '#243447')
      root.style.setProperty('--el-fill-color-light', '#1e2a3a')
      root.style.setProperty('--el-fill-color-lighter', '#16213e')
